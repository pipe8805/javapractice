...
public class BeerSong {
    private static class BeerBuilder {
        ...
        public BeerBuilder count() {
            return add(n == 0 ? "no more" : Integer.toString(n));
        }

        public BeerBuilder bottles() {
            return add(n == 1 ? "bottle" : "bottles");
        }

        public BeerBuilder ofBeer() {
            return add("of beer");
        }

        public BeerBuilder onTheWall() {
            return add("on the wall");
        }
    ...
    public static void main(String args[]){
        System.out.println(BeerSong.sing(2,1));
    }
}